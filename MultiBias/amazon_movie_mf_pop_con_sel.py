...
from models import BiasFactMFExplicitThreeBias
from train import ExplicitTrainThreeBiasManager
...
DATASET_PATH = 'amazon-movie-mf-pop-con-sel'
...
def main(
    ...
    model: BiasFactMFExplicitThreeBias = BiasFactMFExplicitThreeBias(
    ...
    train_manager: ExplicitTrainThreeBiasManager = ExplicitTrainThreeBiasManager(
        model=model,
        evaluator=evaluator,
...
if __name__ == '__main__':
    rc_alpha, rc_beta, rc_gama, dist_alpha, dist_beta, avg_alpha, avg_beta = 5, -0.1, 0, 1, -2, 4, 3
