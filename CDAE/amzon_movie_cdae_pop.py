...
from models import BiasFactCDAEImplicit
from train import ImplicitTrainManagerAmazon
...
DATASET_PATH = 'amazon-movie-cdae-pop/'
...
def main(
    ...
    model: BiasFactCDAEImplicit = BiasFactCDAEImplicit(
    ...
    train_manager: ImplicitTrainManagerAmazon = ImplicitTrainManagerAmazon(
        model=model,
        evaluator=evaluator,
        training_data=train_tensor,
        env_label=torch.LongTensor(data_loader.train_df['pop_label'].tolist()),
        device=device,
