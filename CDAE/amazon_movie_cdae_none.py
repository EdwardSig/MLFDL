...
from models import CDAEImplicit
from train import ImplicitTrainManager, ImplicitTrainManagerNone
...
DATASET_PATH = 'amazon-movie-cdae-none/'
...
def main(
    ...
    model: CDAEImplicit = CDAEImplicit(
    ...
    train_manager: ImplicitTrainManagerNone = ImplicitTrainManagerNone(
        model=model,
        evaluator=evaluator,
